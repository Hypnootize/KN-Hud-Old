...
**2)** Copy the KN Hud OLD folder (**NOT** KN-Hud-OLD-Master, the one inside it!)

**3)** Paste The folder to your custom tf folder (C:\Program Files (x86)\Steam\SteamApps\common\Team Fortress 2\tf\custom\KN Hud OLD)
...
The original rgb code for the damage numbers is: hud_combattext_red 144; hud_combattext_green 223; hud_combattext_blue 0
